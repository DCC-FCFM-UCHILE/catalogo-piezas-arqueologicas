# Generated by Django 3.2.25 on 2024-12-16 13:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='request',
            name='artifact',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='request', to='piezas.artifact'),
        ),
        migrations.AddField(
            model_name='request',
            name='artifact_request',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='piezas.bulkdownloadingrequest'),
        ),
        migrations.AddConstraint(
            model_name='model',
        ...
        migrations.AddField(
            ...
            name='institution',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='institution_requester', to='piezas.institution'),
        ),
        migrations.AddField(
